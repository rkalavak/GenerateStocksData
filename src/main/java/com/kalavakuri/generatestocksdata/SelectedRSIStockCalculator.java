...
public class SelectedRSIStockCalculator {

	private static final String MONEY_CONTROL_STOCK_URL = "https://priceapi.moneycontrol.com/pricefeed/nse/equitycash/";
	private static final String NSE_HISTORY_URL = "https://www.nseindia.com/api/historical/cm/equity?symbol=&series=[%22EQ%22]&from=01-01-2023&to=06-07-2023";
	...
	public static void main(String[] args) throws Exception {
		...
		Response responseStock = Jsoup.connect(MONEY_CONTROL_STOCK_URL + "GSL06").ignoreContentType(true).userAgent(
